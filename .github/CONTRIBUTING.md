...
1. Leia [docs/README.md](../docs/README.md). As regras de ouro estão lá.
2. Escolha uma task no quadro (ou abra uma com o template **Task**), sempre ligada a uma feature de [`feature/`](../feature/README.md).
3. Crie uma branch a partir da `main`: `feat/W2-mapa-de-relevo` ([fluxo-git](../docs/fluxo-git.md)).
4. Implemente seguindo os [padrões de código](../docs/padroes-de-codigo.md) e os critérios de aceite da feature.
