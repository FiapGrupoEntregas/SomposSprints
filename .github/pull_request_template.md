...
<!-- Resumo em 1–3 frases. O título do PR segue Conventional Commits: feat(api): adiciona rota de relevo (W2) -->

## 🔗 Feature / Task

- Feature: <!-- ex.: W2 — feature/W2-mapa-de-relevo.md -->
...
<!-- Passo a passo que QUALQUER pessoa do time consiga seguir (inclusive quem não programa). -->
1.
2.
3.
...
<!-- Se o README não precisou mudar, explique aqui por quê: -->
