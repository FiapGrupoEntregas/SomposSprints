...
def client() -> TestClient:
    app.dependency_overrides[get_settings] = lambda: Settings(api_keys=f"{API_KEY},{OTHER_KEY}")
...
def test_reading_stays_open_in_the_demo(client: TestClient) -> None:
    """ADR-013: só escrita e publicação são protegidas; o resto fica aberto na demo."""
